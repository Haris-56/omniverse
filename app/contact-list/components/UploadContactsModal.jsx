      ...
      <div className="bg-[#FCF8FE] rounded-[4rem] shadow-[0_50px_100px_rgba(130, 69, 239,0.15)] w-full max-w-2xl overflow-hidden border border-[#8245EF]/15 relative z-10 animate-in zoom-in-95 duration-500 my-auto group/modal">
        ...
        <div className="p-10 border-b border-[#8245EF]/10 flex justify-between items-center bg-white/40">
           <div className="flex items-center gap-6">
              ...
              <div>
                 <h2 className="text-3xl font-black text-[#161932] tracking-tighter uppercase leading-none">Mass_Ingest</h2>
                 <p className="text-[10px] font-black text-[#8245EF] uppercase tracking-[0.4em] mt-2 font-mono italic leading-none">Neural_Data_Streaming</p>
              </div>
           </div>
        ...
        <div className="p-12">
          {success ? (
            <div className="text-center py-20 animate-in slide-in-from-bottom duration-500">
               ...
               <h3 className="text-4xl font-black text-[#161932] mb-4 tracking-tighter uppercase">Sync_Complete</h3>
               <p className="text-[#64748b] font-black italic text-lg uppercase tracking-widest font-mono text-[12px]">Cluster nodes successfully populated with new prospect data.</p>
            </div>
          ) : (
            <div className="space-y-12">
              <div className="relative group/upload">
                ...
                <label
                  ...
                  className={`flex flex-col items-center justify-center w-full min-h-[350px] border-2 border-dashed rounded-[3.5rem] cursor-pointer transition-all duration-700 bg-white/30 hover:bg-white/60 ${
                    file ? "border-emerald-500/40 shadow-[0_0_30px_rgba(16,185,129,0.05)]" : "border-[#8245EF]/20 hover:border-[#8245EF]/50 shadow-inner"
                  }`}
                >
                  <div className="flex flex-col items-center justify-center p-12 text-center">
                    <div className={`p-8 rounded-[2.5rem] border mb-8 transition-all duration-700 ${
                       file ? "bg-emerald-50 text-emerald-500 border-emerald-200 shadow-sm scale-110" : "bg-white text-[#94a3b8] border-[#8245EF]/10 group-hover/upload:scale-110 group-hover/upload:rotate-6 group-hover/upload:text-[#8245EF] group-hover/upload:border-[#8245EF]/30 shadow-md"
                    }`}>
                    ...
                    {file ? (
                      <div className="space-y-4 animate-in zoom-in duration-500">
                        <p className="text-3xl font-black text-[#161932] tracking-tighter uppercase">{file.name}</p>
                      ...
                      <>
                        <h4 className="text-3xl font-black text-[#161932] mb-4 tracking-tighter uppercase">Select_CSV_Fragment</h4>
                        <p className="text-[#64748b] text-[11px] font-black uppercase tracking-[0.3em] max-w-sm mx-auto leading-relaxed italic font-mono opacity-60">
              ...
              <div className="grid grid-cols-2 gap-10">
                 <button
                    onClick={onClose}
                    className="py-6 bg-white text-[#94a3b8] font-black text-[12px] uppercase tracking-[0.5em] rounded-[2rem] hover:bg-rose-50 hover:text-rose-500 transition-all border border-[#8245EF]/10 active:scale-95 font-mono shadow-sm"
                 >
                    Terminate
                 </button>
                 <button
                    ...
                    className="py-6 bg-[#8245EF] text-white font-black text-[12px] uppercase tracking-[0.5em] rounded-[2rem] shadow-[0_25px_50px_rgba(130, 69, 239,0.3)] hover:bg-[#6d28d9] transition-all disabled:opacity-30 flex items-center justify-center gap-5 border border-white/10 font-mono active:scale-95 group/btn"
                 >
                    {loading ? (
        ...
        {/* Footer info */}
        <div className="p-10 bg-[#FCF8FE]/50 border-t border-[#8245EF]/10 flex items-center justify-between relative overflow-hidden">
           <div className="flex items-center gap-4 relative z-10">
              <ShieldCheck size={20} className="text-emerald-500" />
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#94a3b8] font-mono italic">Node_Integrity_Verified</span>
           </div>
           <Activity size={20} className="text-[#8245EF] relative z-10 animate-pulse" />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.03] pointer-events-none -z-10 grayscale group-hover/modal:opacity-[0.06] transition-opacity duration-1000">
           <Hexagon size={320} strokeWidth={1} className="text-[#8245EF] animate-spin-slow" />
        </div>
      </div>
    </div>
  );
