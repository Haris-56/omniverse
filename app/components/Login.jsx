          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full mt-1 px-4 py-2 bg-gray-100 rounded-xl outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-[#6F3FF5] text-white font-medium text-lg hover:bg-[#5c2cd9] shadow-lg transition disabled:opacity-70"
            >
