      ...
      <div className="max-w-[1400px] mx-auto space-y-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 border-b border-[#B78D7D]/15 pb-8">
          <div>
            ...
            <h1 className="text-3xl font-black text-[#3E3A39] tracking-tighter uppercase leading-tight">Instagram</h1>
            <p className="text-[#8E7A70] mt-3 text-lg font-medium max-w-2xl leading-relaxed">Connect and manage your Instagram accounts to automate your engagement.</p>
          </div>
          <button
            onClick={() => {
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-40 space-y-8 text-center">
             <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <Image size={20} className="text-[#B78D7D] animate-pulse" />
                </div>
             </div>
          ...
          <div className="flex flex-col items-center justify-center py-32 bg-white rounded-[2.5rem] border border-dashed border-[#B78D7D]/20 text-center shadow-sm p-12 max-w-3xl mx-auto relative overflow-hidden group">
            ...
            <p className="text-[#8E7A70] mt-4 max-w-md mx-auto leading-relaxed text-lg">Connect your first Instagram account to start automating your visual outreach and engagement.</p>
            <button
              onClick={() => {
                setSelectedAccount(null);
                setIsConnectModalOpen(true);
            ...
            {accounts.map((account) => (
              ...
              >
                ...
                <div className="p-8 pb-6 flex-1 relative z-10 flex flex-col">
                  ...
                  <p className="text-[10px] font-black text-[#B2AAA6] uppercase tracking-[0.2em] mb-10 font-mono">ID: {account._id.slice(-8).toUpperCase()}</p>
                  ...
                  <div className="flex items-center justify-between mb-8">
                    ...
                    {account.status !== "Connected" && (
                        <button 
                            ...
                            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#B78D7D] text-white text-[8px] font-black uppercase tracking-widest border border-white/10 hover:bg-[#A37B6D] transition-all shadow-md font-mono active:scale-95"
                        >
                  ...
                  <div className="grid grid-cols-2 gap-4 p-6 bg-[#F8F4F2]/50 rounded-[1.5rem] border border-[#B78D7D]/10 group-hover:bg-white transition-all duration-500 shadow-inner mt-auto">
                    <div className="text-center">
                      <p className="text-[8px] font-black text-[#B2AAA6] uppercase tracking-[0.3em] mb-2 font-mono">Posts</p>
                    ...
                    <div className="text-center border-l border-[#B78D7D]/10">
                      <p className="text-[8px] font-black text-[#B2AAA6] uppercase tracking-[0.3em] mb-2 font-mono">Replies</p>
                      <p className="font-black text-[#3E3A39] text-2xl tracking-tighter leading-none">--</p>
                    </div>
                  </div>
                </div>
