    ...
    <div className="w-full animate-in fade-in slide-in-from-bottom-6 duration-1000 font-sans pb-32 p-6 md:p-10 lg:p-12 min-h-screen bg-[#FCF8FE]/50">
      <div className="max-w-[1400px] mx-auto space-y-12">
        ...
        <div className="flex items-center gap-6">
          <Link href="/instagram" className="p-4 bg-white border border-[#8245EF]/10 rounded-2xl text-[#94a3b8] hover:text-[#8245EF] transition-all shadow-sm hover:bg-[#FCF8FE] group">
            <ChevronLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
          </Link>
          <div className="flex items-center gap-3 text-[9px] font-black uppercase tracking-[0.2em] font-mono text-[#94a3b8]">
             <Link href="/instagram" className="hover:text-[#8245EF] transition-colors">Instagram Accounts</Link>
        ...
        {loading && campaigns.length === 0 ? (
          ...
          <div className="bg-white rounded-[2.5rem] border border-dashed border-[#8245EF]/30 py-32 flex flex-col items-center text-center px-10 shadow-lg p-16 max-w-3xl mx-auto relative overflow-hidden group">
            ...
            <p className="text-[#64748b] text-lg font-medium max-w-lg mb-12 relative z-10">
                    ...
                    <tr key={camp._id} className="group hover:bg-[#FCF8FE]/30 transition-all cursor-default">
                      <td className="p-8 pl-10">
                        <div className="flex items-center gap-6">
                           ...
                           <div>
                              ...
                              <p className="text-[9px] font-black text-[#94a3b8] uppercase tracking-[0.2em] font-mono mt-2">Verified Plan</p>
                           </div>
                        </div>
                      </td>
                      <td className="p-8">
                      ...
                      <td className="p-8">
                         <div className="flex flex-col items-center">
                            ...
                            <span className="text-[8px] font-black text-[#94a3b8] uppercase tracking-widest font-mono">Posts Sent</span>
                         </div>
                      </td>
