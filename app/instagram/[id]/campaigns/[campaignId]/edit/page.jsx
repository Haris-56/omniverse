        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
          <div className="flex items-center gap-8">
            ...
            <div>
               ...
               <h1 className="text-4xl font-black text-[#161932] tracking-tighter uppercase leading-tight">Update Instagram Plan</h1>
               <p className="text-[#64748b] mt-3 text-lg font-medium">Changing settings for: <span className="text-[#8245EF] font-black">{account?.username}</span></p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-[2.5rem] border border-[#8245EF]/15 shadow-sm overflow-hidden group hover:shadow-[0_20px_40px_rgba(130, 69, 239,0.05)] transition-all">
            ...
            <div className="p-10 md:p-12 space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div onClick={() => setWatchHighlights(!watchHighlights)} className={`p-6 rounded-[1.5rem] border-2 transition-all cursor-pointer flex flex-col items-center text-center gap-3 ${watchHighlights ? 'bg-[#8245EF]/10 border-[#8245EF] shadow-xl' : 'bg-[#FCF8FE]/30 border-transparent hover:border-[#8245EF]/10'}`}>
                ...
                <div onClick={() => setEnableAiAgent(!enableAiAgent)} className={`p-6 rounded-[1.5rem] border-2 transition-all cursor-pointer flex flex-col items-center text-center gap-3 ${enableAiAgent ? 'bg-indigo-50 border-indigo-200 shadow-xl' : 'bg-[#FCF8FE]/30 border-transparent hover:border-indigo-400/10'}`}>
                                  ...
                                  {['story', 'highlight', 'message'].map((method) => {
                                    ...
                                    return (
                                      <div 
                                        ...
                                        className={`flex-1 py-3 text-center rounded-lg border transition-all cursor-pointer font-black text-[8px] uppercase tracking-widest ${isStepActive ? 'bg-[#8245EF] border-[#8245EF] text-white shadow-lg' : 'bg-white border-[#8245EF]/10 text-[#94a3b8] hover:border-[#8245EF]/30'}`}
                                      >
             ...
             <div className="flex-1 relative z-10 w-full">
                <div className="flex items-center gap-5 mb-8">
                   ...
                   <div>
                      ...
                      <p className="text-[9px] font-black text-[#94a3b8] tracking-[0.3em] uppercase mt-2 font-mono">Control Protocol Activation</p>
                   </div>
                </div>
