        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
          <div className="flex items-center gap-8">
            ...
            <div>
               ...
               <h1 className="text-4xl font-black text-[#3E3A39] tracking-tighter uppercase leading-tight">Update Instagram Plan</h1>
               <p className="text-[#8E7A70] mt-3 text-lg font-medium">Changing settings for: <span className="text-[#B78D7D] font-black">{account?.username}</span></p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-[2.5rem] border border-[#B78D7D]/15 shadow-sm overflow-hidden group hover:shadow-[0_20px_40px_rgba(183,141,125,0.05)] transition-all">
            ...
            <div className="p-10 md:p-12 space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div onClick={() => setWatchHighlights(!watchHighlights)} className={`p-6 rounded-[1.5rem] border-2 transition-all cursor-pointer flex flex-col items-center text-center gap-3 ${watchHighlights ? 'bg-[#B78D7D]/10 border-[#B78D7D] shadow-xl' : 'bg-[#F8F4F2]/30 border-transparent hover:border-[#B78D7D]/10'}`}>
                ...
                <div onClick={() => setEnableAiAgent(!enableAiAgent)} className={`p-6 rounded-[1.5rem] border-2 transition-all cursor-pointer flex flex-col items-center text-center gap-3 ${enableAiAgent ? 'bg-indigo-50 border-indigo-200 shadow-xl' : 'bg-[#F8F4F2]/30 border-transparent hover:border-indigo-400/10'}`}>
                                  ...
                                  {['story', 'highlight', 'message'].map((method) => {
                                    ...
                                    return (
                                      <div 
                                        ...
                                        className={`flex-1 py-3 text-center rounded-lg border transition-all cursor-pointer font-black text-[8px] uppercase tracking-widest ${isStepActive ? 'bg-[#B78D7D] border-[#B78D7D] text-white shadow-lg' : 'bg-white border-[#B78D7D]/10 text-[#B2AAA6] hover:border-[#B78D7D]/30'}`}
                                      >
          ...
          <div className="bg-[#3E3A39] rounded-[3rem] border border-[#B78D7D]/15 shadow-2xl p-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden group/footer">
             ...
             <div className="flex-1 relative z-10 w-full">
                <div className="flex items-center gap-5 mb-8">
                   ...
                   <div>
                      <h3 className="text-2xl font-black text-white tracking-tighter uppercase leading-none">Finished!</h3>
                      <p className="text-[9px] font-black text-[#B2AAA6] tracking-[0.3em] uppercase mt-2 font-mono">Control Protocol Activation</p>
                   </div>
                </div>
                ...
                >
                   {submitting ? (
                      ...
                      <div className="flex items-center gap-4">
                         ...
                         <Save size={24} className="group-hover/submit:translate-x-2 transition-transform duration-700" />
                      </div>
                   )}
                </button>
                <button
