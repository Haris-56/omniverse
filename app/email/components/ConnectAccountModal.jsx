      ...
      <div className="bg-white rounded-[4rem] shadow-[0_80px_160px_rgba(130, 69, 239,0.2)] w-full max-w-7xl overflow-hidden border border-[#8245EF]/20 relative z-10 animate-in zoom-in-95 duration-1000 my-auto">
        ...
        <div className="p-10 border-b border-[#8245EF]/10 flex justify-between items-center bg-[#FCF8FE]/50">
          <div className="flex items-center gap-6">
             ...
             <div>
                <h2 className="text-3xl font-black text-[#161932] tracking-tighter uppercase">SMTP Bridge</h2>
                <p className="text-[10px] font-black text-[#8245EF] uppercase tracking-[0.4em] mt-1 font-mono">Provision_Outreach_Protocol</p>
             </div>
          </div>
        ...
        <div className="p-12 custom-scrollbar max-h-[70vh] overflow-y-auto">
          {result ? (
            <div className="text-center py-16 animate-in slide-in-from-bottom duration-500">
              ...
              <h3 className="text-4xl font-black text-[#161932] mb-4 tracking-tighter uppercase">Bridge Active</h3>
              <p className="text-[#64748b] font-bold italic text-lg">Your SMTP node is now broadcasting on the outreach frequency.</p>
            </div>
          ) : (
            <form onSubmit={handleConnect} className="space-y-10">
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.4em] ml-2 font-mono">System Email</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2 space-y-4">
                   <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.4em] ml-2 font-mono">SMTP Host</label>
                   <div className="relative group">
                        <Server size={20} className="absolute left-6 top-1/2 -translate-y-1/2 text-[#94a3b8] group-focus-within:text-[#8245EF] transition-colors" />
                        <input
                        type="text"
                        value={host}
                        onChange={(e) => setHost(e.target.value)}
                        className="w-full bg-[#FCF8FE]/50 border border-[#8245EF]/10 rounded-2xl pl-16 pr-8 py-5 text-sm font-bold text-[#161932] outline-none focus:border-[#8245EF] transition-all font-mono shadow-sm"
                        placeholder="smtp.provider.com"
                        />
                   </div>
                </div>
                <div className="space-y-4">
                   <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.4em] ml-2 font-mono">Port</label>
                   <input
                    type="text"
                    value={port}
                    onChange={(e) => setPort(e.target.value)}
                    className="w-full bg-[#FCF8FE]/50 border border-[#8245EF]/10 rounded-2xl px-8 py-5 text-sm font-bold text-[#161932] outline-none focus:border-[#8245EF] transition-all font-mono text-center shadow-sm"
                    placeholder="465"
                    />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.4em] ml-2 font-mono">App Passkey</label>
                <div className="relative group">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 pt-4">
                <div className="flex items-center gap-4 bg-[#FCF8FE]/50 p-6 rounded-2xl border border-[#8245EF]/10 flex-1 w-full box-border">
                   <div className="group cursor-pointer flex items-center gap-4" onClick={() => setSecure(!secure)}>
                      <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all ${secure ? 'bg-[#8245EF] border-[#8245EF]' : 'border-[#8245EF]/20 bg-white'}`}>
                ...
                <div className="flex items-center gap-3 px-6 py-4 bg-white rounded-2xl border border-[#8245EF]/10 shadow-sm">
                    <ShieldCheck size={20} className="text-[#8245EF]" />
                    <span className="text-[10px] font-black text-[#94a3b8] uppercase tracking-widest font-mono">Secured_Link</span>
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#8245EF] text-white py-6 rounded-[2rem] font-black text-lg shadow-[0_20px_40px_rgba(130, 69, 239,0.3)] hover:bg-[#6d28d9] transition-all disabled:opacity-50 flex items-center justify-center gap-5 active:scale-[0.98] border border-white/10 mt-10 uppercase tracking-[0.3em] font-mono text-[12px]"
              >
                {loading ? (
                  <>
        ...
        <div className="p-10 bg-[#FCF8FE]/50 border-t border-[#8245EF]/10 flex items-center justify-center gap-4">
           ...
           <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#94a3b8] font-mono">SMTP Protocol Layer 7 Secure</span>
        </div>
      </div>
    </div>
  );
