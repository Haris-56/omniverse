...
import { Plus, Facebook, Trash2, AlertCircle, CheckCircle, MoreVertical } from "lucide-react";
    ...
    <div className="w-full p-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage your connected accounts for automation</p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl border border-dashed border-gray-200 text-center">
          <div className="w-16 h-16 bg-blue-50 text-[#1877F2] rounded-full flex items-center justify-center mb-4">
            <Facebook size={32} />
          </div>
          <h3 className="text-lg font-medium text-gray-900 mb-2">No Accounts Connected</h3>
          <p className="text-gray-500 max-w-sm mb-6">
            Connect your Facebook account to start automating your campaigns and outreach.
          </p>
          <button
            onClick={() => setIsConnectModalOpen(true)}
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 bg-blue-50 text-[#1877F2] rounded-full flex items-center justify-center">
                    <Facebook size={24} />
                  </div>
                  <button
