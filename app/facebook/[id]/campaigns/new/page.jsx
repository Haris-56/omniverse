...
export default function NewCampaignPage({ params: paramsPromise }) {
  ...
  const [followUps, setFollowUps] = useState([]); // [{ delayDays: 1, message: "" }]
    ...
    <div className="w-full min-h-screen bg-gray-50/50 p-4 md:p-8 animate-in fade-in duration-500">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-10">
          <Link href={`/facebook/${accountId}/campaigns`} className="p-3 bg-white border border-gray-100 rounded-2xl text-gray-400 hover:text-gray-900 transition-all shadow-sm">
            <ChevronLeft size={20} />
          </Link>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          {/* Section 2: Payload Configuration */}
          <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/20 overflow-hidden">
            <div className="p-6 md:p-8 border-b border-gray-50 flex items-center gap-4 bg-gray-50/30">
              <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm text-indigo-600">
                <Cpu size={24} />
            ...
            <div className="p-8 md:p-10 space-y-8">
              <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                 ...
                 {!showSaveTemplate ? (
                    ...
                    <div className="flex-1 w-full p-6 bg-indigo-50/30 rounded-3xl border border-indigo-50 flex flex-col gap-4">
                       <input
                        type="text"
                        value={templateName}
                   ...
                   <div className="flex items-center gap-2">
                      {["$$f_name$$", "$$l_name$$", "$$full_name$$"].map(v => (
                        <button
                          ...
                          className="px-3 py-1 bg-white border border-gray-100 rounded-lg text-[9px] font-black text-indigo-600 hover:border-indigo-200 hover:bg-indigo-50 transition-all"
                        >
                          {v}
                        </button>
                      ))}
            ...
            <div className="p-8 md:p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input type="number" value={maxDelay} onChange={(e) => setMaxDelay(e.target.value)} className="w-full bg-gray-50 border border-gray-100 rounded-xl p-3 text-center font-bold" />
                </div>
              </div>
              <div className="space-y-3">
                ...
                <select 
                  ...
                  className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-4 font-bold text-xs appearance-none"
                >
              ...
              {followUps.length === 0 ? (
                ...
                <div className="space-y-6">
                  {followUps.map((step, idx) => (
                    <div key={idx} className="bg-gray-50/50 rounded-3xl border border-gray-100 p-8 relative group hover:bg-white hover:border-indigo-100 transition-all">
                       <button
                        type="button"
