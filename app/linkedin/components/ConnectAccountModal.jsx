      ...
      <div className="bg-white rounded-[4rem] shadow-[0_80px_160px_rgba(130, 69, 239,0.2)] w-full max-w-[1400px] overflow-hidden border border-[#8245EF]/20 relative z-10 animate-in zoom-in-95 duration-1000 my-auto">
        ...
        <div className="p-10 border-b border-[#8245EF]/10 flex justify-between items-center bg-[#FCF8FE]/50">
          <div className="flex items-center gap-6">
             ...
             <div>
                <h2 className="text-3xl font-black text-[#161932] tracking-tighter uppercase leading-none">LinkedIn</h2>
                <p className="text-[10px] font-black text-[#8245EF] uppercase tracking-[0.4em] mt-1 font-mono leading-none">Manage your social accounts here.</p>
             </div>
          </div>
            ...
            <div className="text-center py-16 animate-in slide-in-from-bottom duration-500">
              {result.status === "Connected" ? (
                <>
                  ...
                  <h3 className="text-4xl font-black text-[#161932] mb-4 tracking-tighter uppercase">Node Activated</h3>
                  <p className="text-[#64748b] font-bold italic text-lg">Your LinkedIn identity is now synchronized with the Omniverse cluster.</p>
                </>
              ) : (
                <>
                  ...
                  <h3 className="text-4xl font-black text-[#161932] mb-4 tracking-tighter uppercase">Signal Loss</h3>
              ...
              {result?.status === "Checkpoint" ? (
                <div className="space-y-10 animate-in slide-in-from-top-4 duration-500">
                   <div className="p-8 bg-[#8245EF]/5 border border-[#8245EF]/10 rounded-[2.5rem] flex gap-6 items-center">
                      ...
                      <div>
                         <p className="text-xl font-black text-[#161932] uppercase">Verification Matrix</p>
                         <p className="text-[10px] font-black text-[#64748b] mt-1 uppercase tracking-widest font-mono">Inject the secure code from your email.</p>
                      </div>
                   </div>

                   <div className="space-y-4">
                    <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.4em] ml-2 font-mono">Quantum Passcode</label>
                    <input
                      type="text"
                      value={twoFactorCode}
                ...
                <>
                  ...
                  <div className="space-y-4">
                    <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.4em] ml-2 font-mono">Cookie Sequence (JSON)</label>
                    <textarea
                      value={cookies}
