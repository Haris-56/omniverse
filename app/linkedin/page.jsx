...
import { Plus, Linkedin, Trash2, AlertCircle, CheckCircle } from "lucide-react";
    ...
    <div className="w-full p-4 md:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 bg-[#0077B5] text-white text-sm font-medium rounded-lg hover:bg-[#006097] transition flex items-center justify-center gap-2 shadow-sm"
        >
          <Plus size={18} />
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl border border-dashed border-gray-200 text-center">
          <div className="w-16 h-16 bg-blue-50 text-[#0077B5] rounded-full flex items-center justify-center mb-4">
            <Linkedin size={32} />
          </div>
