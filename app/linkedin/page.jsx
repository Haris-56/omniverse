              ...
              >
                 <div className="flex items-start justify-between mb-8">
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-[#0A66C2] text-white rounded-lg flex items-center justify-center border-2 border-white shadow-sm scale-90">
