      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-3xl overflow-hidden border border-[#8245EF]/20 relative z-10 animate-in zoom-in-95 duration-700 flex flex-col max-h-[90vh] my-auto">
        ...
        <div className="p-8 border-b border-[#8245EF]/10 flex justify-between items-center bg-[#FCF8FE]/30">
           <div className="flex items-center gap-6">
              ...
              <div>
                 ...
                 <p className="text-[10px] font-black text-[#8245EF] uppercase tracking-[0.4em] mt-3 font-mono leading-none">The computer writes messages for you.</p>
              </div>
           </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          <form id="creator-form" onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.4em] ml-2 font-mono">What do you do?</label>
              <div className="relative group">
                <input
                  ...
                  required
                  className="w-full bg-[#FCF8FE]/50 border-2 border-transparent border-b-[#8245EF]/10 rounded-2xl pl-16 pr-8 py-5 text-base font-bold text-[#161932] outline-none focus:border-b-[#8245EF] focus:bg-white transition-all shadow-inner font-sans"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-4">
                ...
                <div className="relative group">
                  ...
                  <Layout className="absolute left-6 top-1/2 -translate-y-1/2 text-[#8245EF]/40 group-focus-within:text-[#8245EF]" size={22} />
              ...
              <div className="space-y-4">
                ...
                <div className="relative group">
                  ...
                  <Mic className="absolute left-6 top-1/2 -translate-y-1/2 text-[#8245EF]/40 group-focus-within:text-[#8245EF]" size={22} />
                   <div className="absolute right-6 top-1/2 -translate-y-1/2 pointer-events-none text-[#8245EF]">
                     <Hexagon size={16} className="animate-spin-slow opacity-50" />
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <label className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.2em] ml-2 font-mono">Post Type</label>
              <div className="grid grid-cols-2 gap-8">
                <label className={`
                  ...
                  ${formData.postType === 'Repost' 
                    ? 'border-[#8245EF] bg-[#8245EF] text-white shadow-xl shadow-[#8245EF]/20' 
                    : 'border-[#8245EF]/10 bg-[#FCF8FE]/50 text-[#94a3b8] hover:border-[#8245EF]/30'}
                `}>
                  <input
                    type="radio"
                    name="postType"
                    ...
                    className="hidden"
                  />
                  <div className={`p-4 rounded-2xl mb-4 transition-all duration-500 ${formData.postType === 'Repost' ? 'bg-white/20' : 'bg-white border border-[#8245EF]/10 group-hover/opt:rotate-12 group-hover/opt:scale-110'}`}>
                    <Repeat size={32} className={`${formData.postType === 'Repost' ? 'text-white' : 'text-[#8245EF]'}`} />
                  </div>
                ...
                `}>
                  <input
                    ...
                    className="hidden"
                  />
                  <div className={`p-4 rounded-2xl mb-4 transition-all duration-500 ${formData.postType === 'New Post' ? 'bg-white/20' : 'bg-white border border-[#8245EF]/10 group-hover/opt:rotate-12 group-hover/opt:scale-110'}`}>
                    <PenTool size={32} className={`${formData.postType === 'New Post' ? 'text-white' : 'text-[#8245EF]'}`} />
                  </div>
        ...
        <div className="p-8 bg-[#FCF8FE]/50 border-t border-[#8245EF]/10 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
           ...
           <div className="flex items-center gap-3 relative z-10">
              ...
              <span className="text-[10px] font-black text-[#94a3b8] uppercase tracking-[0.2em] font-mono">Ready to Start</span>
           </div>
